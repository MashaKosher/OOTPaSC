...
public class Rectangle extends DisplayObject{
    public int w, h;
    public int x1, y1;
    public Rectangle(int x1, int y1,int w,int h, int r1, int g1, int b1,int r2, int g2, int b2, int lineSize) {
    ...
    public Rectangle(int x1, int y1,int a,int r1, int g1, int b1,int r2, int g2, int b2, int lineSize) {
      this(x1,y1,a,a,r1,g1,b1,r2,g2,b2,lineSize);
