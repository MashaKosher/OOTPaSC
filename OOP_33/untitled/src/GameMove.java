...
public class GameMove extends JFrame implements Runnable {
    ...
    public static  void main(String[] args) {
        ...
        new GameMove(1440, 818,"Game",50,50,1432,789,10,120,160,4,168,187,186,151,246,243,20,2);
    ...
    public GameMove(int w, int h,String title,int x1, int y1, int x2, int y2, int r,int g, int b, int window, int r1, int g1, int b1,int r2, int g2, int b2, int frameSize,int type) {
        ...
        this.type=type;
//MenuItem i=new MenuItem("Rectangle",200,50,200,200,"Serif Bold",5,"test text for gthtyjc gh",20,40,59,32,134,39,200,134,23,5);
        panel=new JPanel() {
            @Override
