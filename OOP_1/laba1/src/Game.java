...
public class Game extends JFrame implements Runnable {
    ...
    public static  void main(String[] args) throws NoSuchMethodException {
        new Game(1440, 818,"Game",5,5,1432,789,10,120,160,4,0,0,0,255,255,255,20);
    }
...
inputField=null;
        ...
        panel.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_TAB) {
                    ...
                    editMenu.isVisible =!editMenu.isVisible;
                    }
                }
            });
        ...
        mouseListener=new MouseAdapter() {
           /* @Override
            ...
            public void mousePressed(MouseEvent e) {
                ...
                System.out.println("pressed"+x+" "+y+" "+count+" "+editMenu.isVisible);
                try {
    ...
    public void itemEditAction(MenuItem item) throws NoSuchMethodException {
        if(item.isOpen){
            ...
            if(item==itemEdit){
                if(itemFont.isOpen)
                    itemFont.changeFillColor(202, 252, 251);
                if(itemType.isOpen)
                    itemType.changeFillColor(202, 252, 251);
            }

            item.colorReturn();
            item.changeFillColor(202, 252, 251);
            for(MenuItem i: item.subItems){
                subHide(i);
            }
            ...
            item.colorOnClick();
            item.changeFillColor(102, 201, 201);
            for(MenuItem i: item.subItems){
                i.isVisiable=true;
            }
            if(newMenu.pressedItem!=null)
    ...
    public void editMenu() throws NoSuchMethodException {
        ...
        defoult=new MenuItem("Rectangle",200,100, gameField.w/2-100, gameField.h/2-50,"Sans Serif",20,"Menu Item",47, 119, 118,190, 199, 199,0,0,0,3,true);
        defoult.dx=200;
        defoult.dy=0;
        ...
        int coord=gameField.w-gameField.lineSize-81;
        int coordy=gameField.lineSize+1;
        // создание элементов отладочного меню и привязка действий по нажатию на элемент
        itemAdd=editMenu.add("Rectangle",80,60,coord,coordy+120,"Sans Serif",20,"Add",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemDelete= editMenu.add("Rectangle",80,60,coord,coordy+60,"Serif Bold",20,"Delete",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemEdit=editMenu.add("Rectangle",80,60,coord,coordy,"Serif Bold",20,"Edit",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemAddSub=editMenu.add("Rectangle",80,60,coord,coordy+180,"Serif Bold",16,"Add sub",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemAddSub.isVisiable=false;
        itemType=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130,coordy,"Serif Bold",16,"Type:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemDelta=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*6,coordy+60,"Serif Bold",16,"Delta:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemPosition=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*6,coordy,"Serif Bold",16,"Coords:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemSize=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*5,coordy+60,"Serif Bold",16,"Size:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemFillColor=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*5,coordy,"Serif Bold",16,"BG color:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemFrameColor=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*4,coordy+60,"Serif Bold",16,"Frame color:\n",53, 139, 137,255, 253, 208, 0,0,0,1,false);
        itemFrameSize=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*4,coordy,"Serif Bold",16,"Frame size:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemText=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*3,coordy+60,"Serif Bold",16,"Text:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemFont=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*3,coordy,"Serif Bold",16,"Font:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemFontSize=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*2,coordy+60,"Serif Bold",16,"Font size:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemFontColor=editMenu.addSub(itemEdit,"Rectangle",130,60,coord-130*2,coordy,"Serif Bold",16,"Font color:\n",53, 139, 137,255, 253, 208,0,0,0,1,false);
        itemTypeRec=editMenu.addSub(itemType,"Rectangle",130,30,coord-130,coordy+150,"Serif Bold",16,"Rectangle",53, 139, 137,255, 253, 208,255, 253, 208,0,true);
        itemTypeSquare=editMenu.addSub(itemType,"Rectangle",130,30,coord-130,coordy+120,"Serif Bold",16,"Square",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemTypeCircle=editMenu.addSub(itemType,"Rectangle",130,30,coord-130,coordy+90,"Serif Bold",16,"Circle",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemTypeEllipse=editMenu.addSub(itemType,"Rectangle",130,30,coord-130,coordy+60,"Serif Bold",16,"Ellipse",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemTypeTriangle=editMenu.addSub(itemType,"Rectangle",130,30,coord-130,coordy+30,"Serif Bold",16,"Triangle",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontBold=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+240,"Serif Bold",16,"Bold",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontItalic=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+210,"Serif Italic",16,"Italic",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontPlain=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+180,"Serif Plain",16,"Plain",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontSerif=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+150,"Serif Plain",16,"Serif",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontSansSerif=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+120,"SansSerif Plain",16,"SansSerif",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontMonospaced=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+90,"Monospaced Plain",16,"Monospaced",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontDialog=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+60,"Dialog Plain",16,"Dialog",53, 139, 137,202, 252, 251,0,0,0,1,false);
        itemFontDialogInput=editMenu.addSub(itemFont,"Rectangle",130,30,coord-130,coordy+30,"DialogInput Plain",16,"DialogInput",53, 139, 137,202, 252, 251,0,0,0,1,false);
...
System.out.println("em size= "+editMenu.menuList.size());
    ...
    public class InfoReader extends SwingWorker<Boolean, String>{
        ...
        public InfoReader (MenuItem item){
           ...
           buffer = createWheelBuffer(50);
            ...
            if(item==itemSize){
                ...
                colorWheel.setBounds(gameField.x1Inner+50,gameField.y2Inner-122,100,110);
        ...
        protected Boolean doInBackground() throws Exception {
            inputField=new Rectangle(gameField.x1Inner+2, itemDelta.y1, itemDelta.x1-gameField.x1Inner-2,120,53, 139, 137,202, 252, 251,1){
                @Override
