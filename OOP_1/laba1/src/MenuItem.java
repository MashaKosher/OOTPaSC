...
public class MenuItem extends DisplayObject{
    ...
    ItemMethod methodClicked;
    ItemMethod methodPressed;
    ItemMethod method2Pressed;
    boolean isPressed;
   ...
   public void draw(Graphics2D g){
    ...
    public void changeSize(int w,int h){
       ...
       this.h=h;
        ...
        //if (type.equals("square")){
         //   form=new Rectangle(x1,y1,w,form.rDraw,form.gDraw,form.bDraw,form.rFill,form.gFill,form.bFill,form.lineSize);
   ...
   public void changeText(String str){
    ...
    public void actionPressedDo() throws InvocationTargetException, IllegalAccessException {
        if (methodPressed!=null&&methodPressed.m!=null&&methodPressed.o!=null){
            try{
            methodPressed.m.invoke(methodPressed.o,methodPressed.params);}catch (InvocationTargetException e) {
